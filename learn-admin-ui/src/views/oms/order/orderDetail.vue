  ...
  <div class="detail-container">
    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <div class="table-layout">
       ...
       <div style="margin-top: 20px" v-if="order.orderType == 3||order.orderType == 4">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
        <span class="font-small">用户附加信息</span>
        <el-card shadow="never" style="margin-top:15px;">  {{order.note}}</el-card>
